...
class ConfirmUsbKey(Page):
    def __init__(self, frontend):
        ...
        self.source = "confirm_usbkey.xml"
    ...
    def load_page(self):
        self.frontend.builder.connect_signals({"on_btn_test_read_clicked" : self.on_btn_test_read_clicked,
    ...
    def on_chk_confirm_drive_toggled(self):
        self.frontend.builder.root_widget.debugln("Toggle")
    ...
    def on_btn_test_read_clicked(self):
